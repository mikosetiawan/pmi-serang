...
<head>
    ...
    <link rel="stylesheet" href="/back/assets/vendor/amsify/amsify.suggestags.css">
    <!-- CSS for this page only -->
    <link rel="stylesheet" href="/back/assets/vendor/ijabo/ijabo.min.css">
    <link rel="stylesheet" href="/back/assets/vendor/ijaboCropTool/ijaboCropTool.min.css">
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <script>
        ...
        { themeMode = defaultThemeMode; } } if (themeMode === "system") { themeMode = window.matchMedia("(prefers-color-scheme: dark)").matches ?
        "dark" : "light"; } document.documentElement.setAttribute("data-bs-theme", themeMode); }
    </script>
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ route('home') }}" class="d-lg-none">
                            <img alt="Logo" src="{{ webLogo()->logo_utama }}"
